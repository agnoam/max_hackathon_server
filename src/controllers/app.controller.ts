...
import { CoriunderRequests, CoriunderCred } from "./coriunder.controller";
import md5 from 'md5';
...
export module AppCtrl {
    ...
    export async function transferAmount_R(req: Request, res: Response): Promise<Response> {
        ...
        CoriunderRequests.TransferAmount(body.userCred, body.destAccountId, body.amount, body.pinCode, body.currencyIso, body.text);
